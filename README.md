...
| **Engage** | `vigil/engage.py` | THE FULL ENGAGEMENT: red vs blue with Brown dropping, the whole thing journaled to Sakshi, verified learnings absorbed into the Undercurrent. The swarm KNOWS when the dust settles. CLI: `python3 vigil/engage.py <target> [rounds]`. |
